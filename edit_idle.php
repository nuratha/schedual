...
<!-- BODY -->
		...
		<header class="p-6 flex justify-center space-x-3 bg-primary">
			<div>
				<!-- Back icon -->
				<a href="./view_idle.php?qid=<?php echo $qid?>">
			...
			<div>
				<!-- DELETE FX-->
				<form action="./includes/deli.inc.php" method="post">
...
<!-- CONTENTS -->
		...
		<main class="p-6"> 
		<form action="includes/editidle.inc.php" method="post">
			<!-- Quest ID -->
