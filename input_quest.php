...
<!-- CONTENTS -->
		...
		<main class="p-6"> 
		<form action="includes/quest.inc.php" method="post">
			<section class="p-6 flex justify-center bg-white">
				...
				<div>
					<input type="text" name="q_name" class="input input-bordered input-primary w-full max-w-xs" placeholder="Quest name">
				</div>
                ...
                <div>
					...
					<textarea name="q_desc" rows="5" class="textarea textarea-primary w-full max-w-xs" placeholder="Quest description"></textarea>
				</div>
				<!-- SAVE BUTTON -->
				<div>
